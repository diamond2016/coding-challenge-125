...
/api/diff-prettyp/
body
diff-prettyp_request: {"string_a": "content_of_string_a", "string_b": "content_of_string_b"}

Returns 
diff-prettyp_response: {"diff": "content of myers_diff.dif_prettyp(string_a, string_b)"}
...
curl -X POST http://localhost:8000/api/diff-prettyp/ \
